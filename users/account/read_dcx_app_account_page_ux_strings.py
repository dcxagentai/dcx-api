...
DCX_APP_ACCOUNT_PAGE_DEFAULT_UX_STRINGS = {
    ...
    "page_title_trade_board": "Trade Board",
    "page_title_trade_chats": "Trade Chats",
    "page_title_trade_objects": "Trade Objects",
    "page_title_topics": "AI Chats",
    ...
    "nav_trades": "Trades",
    "nav_my_trades_section": "My Trades",
    "nav_trade_board": "Trade Board",
    "nav_trade_chats": "Trade Chats",
    "nav_trade_objects": "Trade Objects",
    ...
    "messages_compose_progress_routing_body": "DCX is deciding whether this is a trade, AI chat, other message, or prohibited content.",
    ...
    "messages_compose_progress_open_outputs_body": "Open the message or jump straight to the created trade/chat output.",
    ...
    "messages_compose_progress_market_topic_singular": "AI chat",
    "messages_compose_progress_market_topic_plural": "AI chats",
    ...
    "messages_compose_outcome_open_topic": "Open chat",
    ...
    "messages_workflow_open_topic": "Open chat",
    ...
    "trades_error_title": "Trade Objects could not load",
    ...
    "topics_search_placeholder": "Search AI chats...",
    "topics_filter_all_statuses": "All statuses",
    "topics_filter_all_sources": "All sources",
    "topics_loading": "Loading AI chats...",
    "topics_error_title": "AI Chats could not load",
    "topics_error_suggested_action": "Retry after confirming the backend is reachable.",
    "topics_empty": "No AI chats match these filters.",
    "topics_table_column_topic": "AI Chat",
    ...
    "topics_detail_empty": "Choose an AI chat to inspect its seeded AI response.",
    "topics_detail_topic_label": "AI Chat",
