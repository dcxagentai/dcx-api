...
tests keep the #AI reference contract and routed text cleanup stable.
"""
...
def test_extracts_market_topic_reference_from_subject_or_body() -> None:
    assert _extract_market_topic_reference_code("Re: DCX AI chat AI42") == "AI42"
    assert _extract_market_topic_reference_code("#ai7 What are the price drivers?") == "AI7"
...
def test_builds_clean_routed_market_topic_email_text_with_subject_and_body() -> None:
    routed_text = build_dcx_cross_surface_routed_message_text(
        message_subject="#AI2 Aluminum premiums",
        message_text=(
            "#AI2 What changed this week?\n"
            "From: chat@mail.dcxagent.ai\n"
            "To: trader@example.com\n"
            "Subject: DCX AI chat AI2"
        ),
        reference_code="AI2",
