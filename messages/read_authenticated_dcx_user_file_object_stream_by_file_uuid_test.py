...
def test_returns_file_stream_when_file_uuid_belongs_to_user(monkeypatch) -> None:
...
def test_returns_none_when_file_uuid_is_invalid() -> None:
    result = read_authenticated_dcx_user_file_object_stream_by_file_uuid(
        authenticated_user_id=7,
        file_uuid="not-a-uuid",
        connect_to_database=lambda **_kwargs: _FakeConnection(_FakeCursor([])),
...
def test_returns_none_when_file_uuid_is_missing() -> None:
    result = read_authenticated_dcx_user_file_object_stream_by_file_uuid(
        authenticated_user_id=7,
        file_uuid="00000000-0000-0000-0000-000000000801",
