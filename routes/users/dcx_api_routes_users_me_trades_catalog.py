"""
CONTEXT:
This file owns the authenticated DCX app HTTP boundary for reading the Trades catalog.
...
dcx_api_routes_users_me_trades_catalog_router = APIRouter(prefix="/users", tags=["users"])


@dcx_api_routes_users_me_trades_catalog_router.get("/me/trades", response_model=None)
        ...
        return JSONResponse(
            ...
            content={
                ...
                "error": {
                    ...
                    "message": "We could not load the Trades view right now.",
