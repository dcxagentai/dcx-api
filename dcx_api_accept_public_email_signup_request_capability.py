...
def accept_public_email_signup_request_capability(
    ...
    CONTRACT:
      ...
      postconditions:
        ...
        - Rejects page URLs outside the explicit public landing-page paths we allow.
      side_effects: []
      idempotent: true
      retry_safe: true
      async: false
    ...
    NARRATIVE:
      WHY this exists:
        - The public signup boundary should be exact and boring: known fields, known origin, known route paths.
      WHEN TO USE it:
      ...
      WHAT CAN GO WRONG:
        ...
        - The landing-page URL can carry unapproved paths.
      WHAT COMES NEXT:
    ...
    normalized_signup_page_url = normalize_public_email_signup_page_url(
        ...
        allowed_paths=PUBLIC_EMAIL_SIGNUP_ALLOWED_SIGNUP_PATHS,
