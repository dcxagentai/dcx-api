...
WITH desired_strings(string_group, string_key, language_code, text_value, is_original) AS (
    VALUES
        ...
        ('app_account_page', 'messages_compose_progress_prohibited_title', 'en', $$Prohibited content$$ , TRUE),
        ('app_account_page', 'messages_compose_progress_prohibited_title', 'es', $$Contenido prohibido$$ , FALSE),
        ('app_account_page', 'messages_compose_progress_prohibited_title', 'fr', $$Contenu interdit$$ , FALSE),
        ('app_account_page', 'messages_compose_progress_prohibited_title', 'de', $$Verbotener Inhalt$$ , FALSE),
        ...
        ('app_account_page', 'messages_compose_progress_prohibited_body', 'en', $$This message was received but blocked by content policy.$$ , TRUE),
        ('app_account_page', 'messages_compose_progress_prohibited_body', 'es', $$Este mensaje se recibió, pero fue bloqueado por la política de contenido.$$ , FALSE),
        ('app_account_page', 'messages_compose_progress_prohibited_body', 'fr', $$Ce message a bien été reçu, mais il a été bloqué par la politique de contenu.$$ , FALSE),
        ('app_account_page', 'messages_compose_progress_prohibited_body', 'de', $$Diese Nachricht wurde empfangen, aber durch die Inhaltsrichtlinie blockiert.$$ , FALSE),
        ...
        ('app_account_page', 'messages_detail_analysis_model_label', 'en', $$Analysis model$$, TRUE),
        ('app_account_page', 'messages_detail_analysis_model_label', 'es', $$Modelo de análisis$$, FALSE),
        ('app_account_page', 'messages_detail_analysis_model_label', 'fr', $$Modèle d'analyse$$, FALSE),
        ('app_account_page', 'messages_detail_analysis_model_label', 'de', $$Analysemodell$$, FALSE),
        ('app_account_page', 'messages_detail_analysis_failed_title', 'en', $$LLM call failed.$$ , TRUE),
        ('app_account_page', 'messages_detail_analysis_failed_title', 'es', $$La llamada al LLM falló.$$ , FALSE),
        ('app_account_page', 'messages_detail_analysis_failed_title', 'fr', $$L'appel au LLM a échoué.$$ , FALSE),
        ('app_account_page', 'messages_detail_analysis_failed_title', 'de', $$Der LLM-Aufruf ist fehlgeschlagen.$$ , FALSE),
        ('app_account_page', 'messages_detail_analysis_failed_body', 'en', $$The message was received, but the AI analysis step did not complete. Please retry.$$ , TRUE),
        ('app_account_page', 'messages_detail_analysis_failed_body', 'es', $$Se recibió el mensaje, pero el paso de análisis con IA no se completó. Vuelve a intentarlo.$$ , FALSE),
        ('app_account_page', 'messages_detail_analysis_failed_body', 'fr', $$Le message a bien été reçu, mais l'étape d'analyse IA ne s'est pas terminée. Veuillez réessayer.$$ , FALSE),
        ('app_account_page', 'messages_detail_analysis_failed_body', 'de', $$Die Nachricht wurde empfangen, aber der KI-Analyseschritt wurde nicht abgeschlossen. Bitte versuchen Sie es erneut.$$ , FALSE),
        ('app_account_page', 'messages_detail_prohibited_title', 'en', $$Prohibited content$$, TRUE),
        ('app_account_page', 'messages_detail_prohibited_title', 'es', $$Contenido prohibido$$, FALSE),
        ('app_account_page', 'messages_detail_prohibited_title', 'fr', $$Contenu interdit$$, FALSE),
        ('app_account_page', 'messages_detail_prohibited_title', 'de', $$Verbotener Inhalt$$, FALSE),
        ('app_account_page', 'messages_detail_prohibited_body', 'en', $$This message was received but blocked by content policy.$$ , TRUE),
        ('app_account_page', 'messages_detail_prohibited_body', 'es', $$Este mensaje se recibió, pero fue bloqueado por la política de contenido.$$ , FALSE),
        ('app_account_page', 'messages_detail_prohibited_body', 'fr', $$Ce message a bien été reçu, mais il a été bloqué par la politique de contenu.$$ , FALSE),
        ('app_account_page', 'messages_detail_prohibited_body', 'de', $$Diese Nachricht wurde empfangen, aber durch die Inhaltsrichtlinie blockiert.$$ , FALSE),
        ('app_account_page', 'messages_detail_prohibited_reasons_label', 'en', $$Reasons$$, TRUE),
        ('app_account_page', 'messages_detail_prohibited_reasons_label', 'es', $$Motivos$$, FALSE),
        ('app_account_page', 'messages_detail_prohibited_reasons_label', 'fr', $$Motifs$$, FALSE),
        ('app_account_page', 'messages_detail_prohibited_reasons_label', 'de', $$Gründe$$, FALSE),
        ('app_account_page', 'messages_detail_retry_analysis_button', 'en', $$Retry analysis$$, TRUE),
        ('app_account_page', 'messages_detail_retry_analysis_button', 'es', $$Reintentar análisis$$, FALSE),
        ('app_account_page', 'messages_detail_retry_analysis_button', 'fr', $$Réessayer l'analyse$$, FALSE),
        ('app_account_page', 'messages_detail_retry_analysis_button', 'de', $$Analyse erneut versuchen$$, FALSE),
        ('app_account_page', 'messages_detail_retry_analysis_pending', 'en', $$Retrying...$$, TRUE),
        ('app_account_page', 'messages_detail_retry_analysis_pending', 'es', $$Reintentando...$$, FALSE),
        ('app_account_page', 'messages_detail_retry_analysis_pending', 'fr', $$Nouvelle tentative...$$, FALSE),
        ('app_account_page', 'messages_detail_retry_analysis_pending', 'de', $$Erneuter Versuch...$$, FALSE),
        ...
        ('app_account_page', 'messages_status_analysis_failed', 'en', $$Analysis failed$$, TRUE),
        ('app_account_page', 'messages_status_analysis_failed', 'es', $$Análisis fallido$$, FALSE),
        ('app_account_page', 'messages_status_analysis_failed', 'fr', $$Échec de l'analyse$$, FALSE),
        ('app_account_page', 'messages_status_analysis_failed', 'de', $$Analyse fehlgeschlagen$$, FALSE),
        ('app_account_page', 'messages_status_prohibited', 'en', $$Prohibited$$, TRUE),
        ('app_account_page', 'messages_status_prohibited', 'es', $$Prohibido$$, FALSE),
        ('app_account_page', 'messages_status_prohibited', 'fr', $$Interdit$$, FALSE),
        ('app_account_page', 'messages_status_prohibited', 'de', $$Verboten$$, FALSE),
        ...
        ('app_account_page', 'messages_title_fallback_prohibited', 'en', $$Prohibited content$$, TRUE),
        ('app_account_page', 'messages_title_fallback_prohibited', 'es', $$Contenido prohibido$$, FALSE),
        ('app_account_page', 'messages_title_fallback_prohibited', 'fr', $$Contenu interdit$$, FALSE),
        ('app_account_page', 'messages_title_fallback_prohibited', 'de', $$Verbotener Inhalt$$, FALSE)
),
language_rows AS (
