...
CREATE TABLE IF NOT EXISTS public.stephen_dcx_admin_tracker_work_items (
    ...
    assigned_to_user_id bigint REFERENCES public.stephen_dcx_users(id) ON DELETE SET NULL,
    is_archived boolean NOT NULL DEFAULT FALSE,
    archived_by_user_id bigint REFERENCES public.stephen_dcx_users(id) ON DELETE SET NULL,
    archived_at_ts_ms bigint,
